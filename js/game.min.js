...
window.cancelAnimationFrame||(window.cancelAnimationFrame=function(a){clearTimeout(a)});window.oa=window.oa||{};window.ha=window.ha||{push:function(){return j}};g={p:h,ba:1,t:900,q:600,Y:0,F:0,canvas:document.getElementById("gamecanvas"),U:document.getElementById("bgcanvas")};g.c=g.canvas.getContext("2d");g.ia=g.U.getContext("2d");g.canvas.setAttribute("width",g.t);g.canvas.setAttribute("height",g.q);g.U.setAttribute("width",g.t);g.U.setAttribute("height",g.q);window.onload=function(){g.p&&(g.c.shadowColor="rgba(0,0,0,0)");g.c.fillStyle="#000";g.c.fillRect(0,0,g.t,g.q);g.a.ea();g.a.ga()};g.d={S:Math.PI,o:Math.PI/2,wa:Math.PI/4,J:2*Math.PI,m:null,n:null,N:400*Math.PI>>0,ma:function(a,b,c,e){a-=c;b-=e;return Math.sqrt(a*a+b*b)},na:function(a){return{left:window.innerWidth/2-a.width/2,top:a.offsetTop}}};g.a={T:0,H:j,paused:j,frame:0.7,h:0,G:Date.now(),I:[],ea:function(){g.d.n=[];for(var a=-g.d.N;a<g.d.N;a++)g.d.n[a]=Math.sin(a/100);g.d.m=[];for(a=-g.d.N;a<g.d.N;a++)g.d.m[a]=Math.cos(a/100);g.k.ta();g.a.G=Date.now();g.a.ka()},la:function(){_gaq.push(["_trackEvent","Game","Death","Score",g.a.T]);g.a.ea()},ga:function(){g.a.G=Date.now();g.a.T=0;g.a.frame=1.9;g.a.field.ja();if(g.a.I.length)for(var a=0,b=g.a.I.length;a<b;a++)g.a.I[a]()},pa:function(){g.a.b.Z();g.a.f.Z()},ra:function(){g.a.field.w();g.a.f.w();
g.a.b.w();g.k.v.w();g.k.ua();g.a.H||g.a.la()},W:function(){if(!g.a.H||g.a.paused)return j;var a=Date.now();g.a.h=a-g.a.G;g.a.frame+=2E-5*g.a.h;g.Y++;g.F+=g.a.h;g.a.G=a;g.a.pa();g.a.ra();requestAnimationFrame(g.a.W)},ka:function(){document.onmousemove=function(a){g.k.v.x=(a.pageX-g.a.field.offset.left)/g.ba;g.k.v.y=(a.pageY-g.a.field.offset.top)/g.ba};document.onmousedown=function(a){g.a.b.da();g.a.b.X=h;g.a.b.g=20;a.stopPropagation();return j};document.onmouseup=function(){g.a.b.X=j};window.onkeydown=
function(a){switch(a.keyCode){case 38:case 87:g.a.b.R=h;break;case 37:case 65:g.a.b.P=h;break;case 39:case 68:g.a.b.Q=h;break;case 40:case 83:g.a.b.O=h;break;case 32:g.a.H?g.a.paused?(g.a.G=Date.now(),g.a.paused=j,requestAnimationFrame(g.a.W)):(g.k.sa(),g.a.paused=h,g.Y=0,g.F=0):(g.a.H=h,g.a.ga(),requestAnimationFrame(g.a.W))}};window.onkeyup=function(a){switch(a.keyCode){case 38:case 87:g.a.b.R=j;break;case 37:case 65:g.a.b.P=j;break;case 39:case 68:g.a.b.Q=j;break;case 40:case 83:g.a.b.O=j}}}};g.a.field={width:g.t,height:g.q,offset:g.d.na(g.canvas),va:"gravel.png",w:function(){g.p&&(g.c.shadowColor="rgba(0,0,0,0)");g.canvas.width=g.canvas.width},ja:function(){var a=document.getElementById("bgimg");g.a.field.V={qa:a,width:a.width,height:a.height};g.ia.drawImage(g.a.field.V.qa,0,0,g.a.field.V.width,g.a.field.V.height,0,0,g.t,g.q)}};g.k={B:function(a){var b={color:"#fff",align:"center",size:15,x:g.t>>1,y:g.q>>1},c;for(c in b)a[c]=a[c]?a[c]:b[c];if(void 0===a.text||!a.text.length)return j;g.p&&(g.c.shadowColor="rgba(0,0,0,0)");g.c.font=a.size+"px arial";b=g.c.measureText(a.text).width;g.c.fillStyle="rgba(0,0,0,0.7)";g.c.fillRect(a.x-(b>>1)-10,a.y-8,b+17,a.size+18);g.c.textAlign=a.align;g.c.textBaseline="top";g.c.fillStyle=a.color;g.c.fillText(a.text,a.x,a.y)},ua:function(){g.k.B({color:"#f0f",text:"Score: "+g.a.T,x:80,y:30});
var a=~~(g.Y/(g.F/1E3));g.k.B({color:"#f0f",text:"FPS: "+a,x:80,y:55});g.p&&(50>a&&1E4<g.F)&&(ctx.shadowColor="rgba(0,0,0,0)",g.p=j)},ta:function(){var a=g.t>>1,b=~~(0.48*g.q),c=~~(0.75*g.q);g.p&&(g.c.shadowColor="rgba(0,0,0,0)");g.c.textBaseline="alphabetic";g.c.fillStyle="rgba(0,0,0,0.7)";g.c.fillRect(a-255,b-88,510,106);g.c.font="98px arial";g.c.fillStyle="#538";g.c.textAlign="center";g.c.fillText("SQUARE'D",a,b);g.c.font="100px arial";g.c.lineWidth=1;g.c.strokeStyle="#a7f";g.c.textAlign="center";
g.c.strokeText("SQUARE'D",a,b);g.k.B({text:"Press space to start",y:c-18});g.k.B({text:"Controls: Arrow keys or W, A, S, D to move; Mouse to aim and fire",y:c+18})},sa:function(){g.k.B({text:"PAUSED",size:60,color:"#538"});g.k.B({text:"Press space to unpause.",y:(g.q>>1)+100})},v:{x:0,y:0,w:function(){g.p&&(g.c.shadowColor="rgba(0,0,0,0)");g.c.strokeStyle="#0ff";g.c.strokeRect(g.k.v.x-4,g.k.v.y-4,8,8)}}};g.a.I.push(function(){g.a.b={x:~~(g.t/2),y:~~(g.q/2),j:100,R:j,O:j,P:j,Q:j,X:j,g:25,A:[],da:function(){g.a.b.A.push({x:g.a.b.x,y:g.a.b.y,e:Math.atan2(g.k.v.x-g.a.b.x,g.k.v.y-g.a.b.y)})},Z:function(){g.a.b.P&&(0<g.a.b.x&&!g.a.b.Q)&&(g.a.b.x-=0.12*g.a.h);g.a.b.Q&&(g.a.b.x<g.a.field.width&&!g.a.b.P)&&(g.a.b.x+=0.12*g.a.h);g.a.b.R&&(0<g.a.b.y&&!g.a.b.O)&&(g.a.b.y-=0.12*g.a.h);g.a.b.O&&(g.a.b.y<g.a.field.height&&!g.a.b.R)&&(g.a.b.y+=0.12*g.a.h);if(g.a.b.X&&0>=(g.a.b.g-=0.2*g.a.h))g.a.b.da(),g.a.b.g=25;
...
g.a.h;if(0>a.x||a.x>g.a.field.width||0>a.y||a.y>g.a.field.height)a.j=0,a.g=0},wanderCurve:function(a){var b=g.a.f.i[a];0<b.u&&(b.u-=g.a.h,0>=b.u&&(b.u=6E3,b.z=0.04*Math.random()-0.02));b.e+=b.z;g.a.f.D.wander(a)},ringerHub:function(a){var b=g.a.f.i[a];if(b.K){for(var c=g.d.J/b.K,e=50*Math.random()+50,f=[-1,1][Math.round(Math.random())]*(0.04*Math.random()+0.06);b.K--;)g.a.f.L({x:b.x,y:b.y,size:32,e:b.K*c,r:a,g:1500,fa:e,l:"ringer",color:"rgba(112,255,152",j:1,z:f,status:"alive",speed:b.speed,C:b.C-
1});b.K=0}g.a.f.D.wanderCurve(a)},ringer:function(a){var b=g.a.f.i[a];if(""===b.r||"dead"===g.a.f.i[b.r].status)return b.l="wander",g.a.f.D.wander(a),h;var a=b.fa,c=g.a.f.i[b.r];0<b.g&&(b.g-=g.a.h,a=(1500-b.g)/1500*b.fa);var e=~~(100*b.e);b.x=g.d.m[e]*a+c.x;b.y=g.d.n[e]*a+c.y;b.e+=b.z;b.e>g.d.S&&(b.e-=g.d.J);b.e<-g.d.S&&(b.e+=g.d.J)},centipede:function(a){var b=g.a.f.i[a];0<b.g&&(b.g-=g.a.h,0>=b.g&&b.C&&(g.a.f.L({x:b.$,y:b.aa,$:b.$,aa:b.aa,size:b.size,e:b.e,u:6E3,z:0.04*Math.random()-0.02,r:a,g:200,
l:"centipede",color:b.color,j:1,status:"alive",speed:b.speed,C:b.C-1}),b.C=0));""===b.r||"dead"===g.a.f.i[b.r].status?(""!==b.r&&(b.r=""),b.color="rgba(220,0,220",g.a.f.D.wanderCurve(a)):(b.color="rgba(140,0,140",a=g.a.f.i[b.r],b.speed=25<g.d.ma(b.x,b.y,a.x,a.y)?0.112:0.05,b.e=Math.atan2(a.x-b.x,a.y-b.y),a=~~(100*b.e),b.x+=g.d.n[a]*b.speed*g.a.h,b.y+=g.d.m[a]*b.speed*g.a.h)},wander:function(a){a=g.a.f.i[a];a.e>g.d.S&&(a.e-=g.d.J);a.e<-g.d.S&&(a.e+=g.d.J);0>a.x?0>a.e&&(a.e=-a.e):a.x>g.a.field.width&&
