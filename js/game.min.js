...
speed:b.speed,p:b.p-1}),b.p=0));if(""===b.j||"dead"===C.b[b.j].status)""!==b.j&&(b.j="",b.d++),b.color="rgba(0,190,240",0<b.i&&(b.i-=y,0>=b.i&&(b.i=6E3,b.q=0.04*Math.random()-0.02)),b.a+=b.q,C.w.wander(a);else{b.color="rgba(0,110,160";var a=C.b[b.j],e=b.x-a.x,k=b.y-a.y;b.speed=20<Math.sqrt(e*e+k*k)?0.092:0.05;b.a=Math.atan2(a.x-b.x,a.y-b.y);a=~~(100*b.a);b.x+=A[a]*b.speed*y;b.y+=B[a]*b.speed*y}},wander:function(a){a=C.b[a];a.a>D&&(a.a-=E);a.a<-D&&(a.a+=E);0>a.x?0>a.a&&(a.a=-a.a):a.x>z.width&&0<a.a&&
(a.a=-a.a);0>a.y?(a.a<-F&&(a.a=-F+(-F-a.a)),a.a>F&&(a.a=F+(F-a.a))):a.y>z.height&&(0>a.a&&a.a>-F&&(a.a=-F+(-F-a.a)),0<a.a&&a.a<F&&(a.a=F+(F-a.a)));var b=~~(100*a.a);a.x+=A[b]*a.speed*y;a.y+=B[b]*a.speed*y}},types:[{size:46,speed:0.042,d:1,color:"rgba(255,0,0",e:"wander",c:0,g:1},{size:22,speed:0.092,d:1,color:"rgba(255,100,0",e:"wander",c:0,g:1},{size:52,speed:0.022,d:3,color:"rgba(255,0,120",e:"chase",c:0,g:1},{size:35,speed:0.092,d:2,color:"rgba(0,170,220",e:"centipede",c:500,g:0.13},{size:28,speed:0.099,
