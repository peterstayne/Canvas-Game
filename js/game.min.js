...
50,m=0.04*Math.random()-0.02,l=0;l<b.t;l++)C.n({x:b.x,y:b.y,size:32,a:l*d,g:a,c:1500,C:j,e:"ringer",color:"rgba(212,212,212",d:1,k:m,status:"alive",speed:b.speed,l:b.l-1});b.t=0}C.m.wanderCurve(a)},ringer:function(a){var b=C.b[a];if(""===b.g||"dead"===C.b[b.g].status)return b.e="wander",C.m.wander(a),c;var a=b.C,d=C.b[b.g];0<b.c&&(b.c-=y,a=(1500-b.c)/1500*b.C);var j=~~(100*b.a);b.x=B[j]*a+d.x;b.y=A[j]*a+d.y;b.a+=b.k;b.a>E&&(b.a-=D);b.a<-E&&(b.a+=D)},centipede:function(a){var b=C.b[a];0<b.c&&(b.c-=
y,0>=b.c&&b.l&&(C.n({x:b.z,y:b.A,z:b.z,A:b.A,size:b.size,a:b.a,i:6E3,k:0.04*Math.random()-0.02,g:a,c:500,e:"centipede",color:b.color,d:1,status:"alive",speed:b.speed,l:b.l-1}),b.l=0));if(""===b.g||"dead"===C.b[b.g].status)""!==b.g&&(b.g=""),b.color="rgba(220,0,220",C.m.wanderCurve(a);else{b.color="rgba(140,0,140";var a=C.b[b.g],d=b.x-a.x,j=b.y-a.y;b.speed=20<Math.sqrt(d*d+j*j)?0.092:0.05;b.a=Math.atan2(a.x-b.x,a.y-b.y);a=~~(100*b.a);b.x+=A[a]*b.speed*y;b.y+=B[a]*b.speed*y}},wander:function(a){a=C.b[a];
a.a>E&&(a.a-=D);a.a<-E&&(a.a+=D);0>a.x?0>a.a&&(a.a=-a.a):a.x>z.width&&0<a.a&&(a.a=-a.a);0>a.y?(a.a<-F&&(a.a=-F+(-F-a.a)),a.a>F&&(a.a=F+(F-a.a))):a.y>z.height&&(0>a.a&&a.a>-F&&(a.a=-F+(-F-a.a)),0<a.a&&a.a<F&&(a.a=F+(F-a.a)));var b=~~(100*a.a);a.x+=A[b]*a.speed*y;a.y+=B[b]*a.speed*y}},types:[{size:46,speed:0.042,d:1,color:"rgba(255,0,0",e:"wander",c:0,h:1},{size:22,speed:0.092,d:1,color:"rgba(255,100,0",e:"wander",c:0,h:1},{size:52,speed:0.022,d:3,color:"rgba(255,0,120",e:"chase",c:0,h:1},{size:22,
speed:0.042,d:5,color:"rgba(64,64,64",e:"ringerHub",c:6E3,h:0.11},{size:31,speed:0.092,d:1,color:"rgba(220,0,220",e:"centipede",c:500,h:0.1},{size:28,speed:0.09,d:2,color:"rgba(255,255,0",e:"wanderChase",c:3900,h:1},{size:20,speed:0.064,d:1,color:"rgba(0,255,255",e:"chase",c:0,h:1},{size:30,speed:0.17,d:1,color:"rgba(255,140,100",e:"divebomb",c:0,h:1},{size:42,speed:0.032,d:5,color:"rgba(255,155,255",e:"wander",c:0,h:1}],n:function(a){G++;var b="e"+G;this.b[b]=a;return b},w:function(){if(v>100*Math.random()){var a,
