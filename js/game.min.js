...
"rgba(255, 255, 255, 1)";p.lineWidth=4;p.beginPath();for(var b in this.e)a=~~(100*Math.atan2(x.x-~~this.e[b].x,x.y-~~this.e[b].y)),p.moveTo(~~this.e[b].x,~~this.e[b].y),p.lineTo(~~this.e[b].x+18*B[a],~~this.e[b].y+18*C[a]);p.stroke();p.closePath()}};D={b:[],q:{wanderChase:function(a){var a=D.b[a],b=Math.atan2(x.x-a.x,x.y-a.y);0>a.d&&(a.a=b,a.d=~~(900*Math.random())+300);b=~~(100*a.a);a.x+=B[b]*a.speed*z;a.y+=C[b]*a.speed*z;a.d-=z},chase:function(a){a=D.b[a];a.a=Math.atan2(x.x-a.x,x.y-a.y);var b=~~(100*
a.a);a.x+=B[b]*a.speed*z;a.y+=C[b]*a.speed*z},divebomb:function(a){var b=~~(100*D.b[a].a),a=D.b[a];a.x+=B[b]*a.speed*z;a.y+=C[b]*a.speed*z;if(0>a.x||a.x>A.width||0>a.y||a.y>A.height)a.c=0,a.d=0},wander:function(a){a=D.b[a];a.a>E&&(a.a-=F);a.a<-E&&(a.a+=F);0>a.x?0>a.a&&(a.a=-a.a):a.x>A.width&&0<a.a&&(a.a=-a.a);0>a.y?(a.a<-G&&(a.a=-G+(-G-a.a)),a.a>G&&(a.a=G+(G-a.a))):a.y>A.height&&(0>a.a&&a.a>-G&&(a.a=-G+(-G-a.a)),0<a.a&&a.a<G&&(a.a=G+(G-a.a)));var b=~~(100*a.a);a.x+=B[b]*a.speed*z;a.y+=C[b]*a.speed*
z}},types:[{size:46,speed:0.042,c:1,color:"rgba(255,0,0",f:"wander"},{size:22,speed:0.092,c:1,color:"rgba(255,100,0",f:"wander"},{size:52,speed:0.022,c:3,color:"rgba(255,0,120",f:"chase"},{size:28,speed:0.099,c:2,color:"rgba(255,255,0",f:"wanderChase",d:3900},{size:20,speed:0.064,c:1,color:"rgba(0,255,255",f:"chase"},{size:30,speed:0.17,c:1,color:"rgba(255,140,100",f:"divebomb"},{size:42,speed:0.032,c:5,color:"rgba(255,155,255",f:"wander"}],s:function(a){this.b.push(a)},o:function(){if(w>100*Math.random()){var a,
b=~~(4*Math.random());a=~~(Math.random()*~~w);a>this.types.length-1&&(a=this.types.length-1);a=this.types[a];a={size:a.size,speed:a.speed,c:a.c,color:a.color,f:a.f};switch(b){case 0:a.x=~~(Math.random()*A.width);a.y=0;break;case 1:a.x=~~(Math.random()*A.width);a.y=A.height;break;case 2:a.x=0;a.y=~~(Math.random()*A.height);break;case 3:a.x=A.width,a.y=~~(Math.random()*A.height)}a.a=Math.atan2(x.x-a.x,x.y-a.y);this.s(a)}for(var f in D.b)b=this.b[f],void 0!==b&&b.c&&(this.q[b.f](f),b.x<x.x+(b.size>>
1)&&(b.x>x.x-(b.size>>1)&&b.y<x.y+(b.size>>1)&&b.y>x.y-(b.size>>1))&&(clearInterval(H),I=d))},g:function(){var a=1,b,f,s,r,l;n&&(p.shadowBlur=5,p.shadowOffsetX=3,p.shadowOffsetY=3);for(var e in this.b)if(void 0!==this.b[e])if(l=this.b[e].size,this.b[e].c)n&&(p.shadowColor="rgba(0,0,0,1)"),r=this.b[e].color+",1)",p.fillStyle!==r&&(p.fillStyle=this.b[e].color+",1)"),p.fillRect(~~this.b[e].x-(l>>1),~~this.b[e].y-(l>>1),l,l);else if(this.b[e].d-=0.1*z,r=this.b[e].d,0>=r)this.b.splice(e,1);else{n&&(p.shadowColor=
"rgba(0,0,0,0)");if(84<r){a=3;p.strokeStyle="rgba(255, 255, 0, 1)";p.lineWidth=4;p.beginPath();f=Math.random()*(110-r);for(s=Math.random()*(140-r);--a;)b=~~(628*Math.random()-314),p.moveTo(~~(this.b[e].h.x+B[b]*f),~~(this.b[e].h.y+C[b]*f)),p.lineTo(~~(this.b[e].h.x+B[b]*s),~~(this.b[e].h.y+C[b]*s));p.stroke();p.closePath()}cacheIndex=~~(100*this.b[e].a);this.b[e].x+=B[cacheIndex]*0.03*r;this.b[e].y+=C[cacheIndex]*0.03*r;a=(r/100).toFixed(2);p.fillStyle=this.b[e].color+","+a+")";l+=~~(l*((100-r)/100));
p.fillRect(~~this.b[e].x-(l>>1),~~this.b[e].y-(l>>1),l,l)}}}}function J(){if(!I||K)return d;var a=Date.now();z=a-t;w+=2E-5*z;L++;M+=z;t=a;x.o();D.o();A.g();D.g();x.g();y.g();j({color:"#f0f",text:"Score: "+v,x:80,y:30});a=~~(L/(M/1E3));j({color:"#f0f",text:"FPS: "+a,x:80,y:55});n&&(50>a&&1E4<M)&&(p.shadowColor="rgba(0,0,0,0)",n=d);I||q();requestAnimationFrame(J)}var N,p,x={},A={},D={},w=0.7,v=0,H,I=d,K=d,E=Math.PI,G=Math.PI/2,F=2*Math.PI,k,m,C,B,O=200*F>>0,y={},z=0,L=0,M=0,n=c,t=Date.now();B=[];
for(var P=-O;P<O;P++)B[P]=Math.sin(P/100);C=[];for(P=-O;P<O;P++)C[P]=Math.cos(P/100);k=900;m=660;N=document.getElementById("gamecanvas");p=N.getContext("2d");bgcanvas=document.getElementById("bgcanvas");bgctx=bgcanvas.getContext("2d");N.setAttribute("width",k);N.setAttribute("height",m);bgcanvas.setAttribute("width",k);bgcanvas.setAttribute("height",m);
